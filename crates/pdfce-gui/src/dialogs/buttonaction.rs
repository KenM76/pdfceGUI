...
//! Copying that would be a regression against what pdfce can say. See
...
/// page, and opening at page 1 is pdfce choosing a destination. An empty box is
...
///   `https` appears zero times in ISO 32000-1 and refusing one would be pdfce

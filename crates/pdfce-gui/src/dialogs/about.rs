...
//!
//! The dispatch target for `file.about`, on **File ▸ pdfce** beside Settings
...
//!
//! `pdfce-gui.exe` redistributes third-party work that `cargo-about` cannot
...
//! open with nothing loaded — an operator who has just launched pdfce and

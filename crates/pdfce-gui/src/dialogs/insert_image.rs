...
//! naming the file's own problem — *"pdfce does not place GIF images"*, *"this
//! image uses {feature}, which pdfce cannot place"* — rather than opening a
...
use egui::Ui;
use pdfce_core::edit::{ImageFit, NewImage};
use pdfce_core::image_import::ImportedImage;
...
impl InsertImageDialog {
    ...
    /// for. Seeding at some fraction of the page would be pdfce choosing a

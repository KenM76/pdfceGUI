...
//!
//! What this governs is a **ce dimension** — one pdfce authors — and not a
//! **pdf dimension**, which is CAD-exported page content pdfce reads and must
...
use egui::Ui;
use pdfce_core::settings::{MAX_PARALLEL_EPSILON_DEGREES, MIN_PARALLEL_EPSILON_DEGREES};
...
mod tests {
    use super::*;
    use pdfce_core::settings::{SettingNote, Settings};

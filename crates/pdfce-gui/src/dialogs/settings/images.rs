...
//!
//! Both settings here are graded **tier (d)** by `pdfce-core` — reasoned
...
use egui::Ui;
use pdfce_core::settings::{MaskResample, MinifyFilter};
...
///
/// `pdfce-core` grades this default tier (d) as explicitly as it grades the
...
///
/// The note does more than confess. `pdfce-render`'s own source asserts *"most

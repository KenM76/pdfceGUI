...
//!
//! Every one of `pdfce-core`'s five authoring verbs refuses a spec whose
...
impl FormFieldDialog {
    ...
    #[must_use]
    pub fn open(page: usize, rect: pdfce_core::page_tree::Rect, draft: Draft) -> Self {
        crate::diag::trace(|| {
            format!(
...
mod tests {
    ...
    fn rect() -> pdfce_core::page_tree::Rect {

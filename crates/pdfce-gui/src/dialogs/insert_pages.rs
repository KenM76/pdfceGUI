...
//!
//! `pdfce_core::pageops::InsertPosition` is `Start` / `End` / `Before(n)` /
...
//!
//! The dialog states what it will do and does it. The one inference pdfce makes
...
/// `pdfce_core::pageops::InsertPosition` at the point of use — because two of
...
impl InsertPagesDialog {
    ...
    const fn position(&self) -> pdfce_core::pageops::InsertPosition {

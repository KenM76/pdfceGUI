...
//!
//! `pdfce-core` refuses a populated group by default and puts the **count** in
...
//! - **pdfce will not delete the dimensions with the group**, and that is the
...
use egui::Ui;
use pdfce_core::dimension::{DEFAULT_GROUP_ID, DimensionModel, Group, GroupId};

...
//!
//! This is the only surface in pdfceGUI that commits an operation nothing can
...
//! destroyed and what pdfce could not destroy**, and the residual half of it is
...
fn residual_lines(prepared: &PreparedRedaction) -> Vec<String> {
    use pdfce_core::redact::CarrierAction;
...
mod tests {
    ...
    fn clean_session() -> pdfce_core::edit::EditSession {
        ...
        let doc = pdfce_core::document::Document::from_bytes(buf).expect("the fixture parses");

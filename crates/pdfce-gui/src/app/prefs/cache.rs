//! # `app::prefs::cache` — how much memory pdfce may spend so a page it has
...
//!
//! Because the honest answer to *"how much of this machine's memory may pdfce
...
/// | | texels | RGBA | roughly |
/// |---|---|---|---|
/// | [`Self::Small`] | 48 M | 192 MB | what pdfce did before 2026-08-19 |
...
pub enum PageCache {
    /// 48 M texels ≈ 192 MB — what pdfce held before 2026-08-19.
    Small,
    /// 128 M texels ≈ 512 MB.
    Medium,

...
pub enum OpeningFit {
    /// The whole page is visible. pdfce's shipped answer.
    ///
...
///
/// `pdfce_core::settings` has **no boolean settings at all** — every one of its
...
/// spelling different from the one they wrote — and a value pdfce silently

...
const LANDED_KEY: &str = "pdfce.filedrag.landed"; // ui-text-exempt: a memory key, never displayed
...
const DIAG_DROP_AFTER_MS: &str = "PDFCE_DIAG_DROP_AFTER_MS"; // ui-text-exempt: an environment variable name, never displayed

...
//!
//! The status bar's left-most line: *what pdfce had to substitute or leave out
...
//! its zoom from the canvas viewport every frame, and the result on pdfce was
...
pub(super) const NOTES_OPEN_ID: &str = "pdfce-status-notes-open"; // ui-text-exempt: widget id, never displayed

...
//!
//! Two methods on [`PdfceApp`], and they are the seam between *what a mode
...
//! | **retire** | [`PdfceApp::on_mode_capabilities_changed`] | anything that was *already there* when the mode was entered |
//!
...
mod tests {
    ...
    /// [`PdfceApp::on_mode_capabilities_changed`] for why a selection is not

...
//! under a drag
//!
//! pdfce's half of [`egui_shell::tabstrip`]. That module draws a row of tabs
...
impl PdfceApp {
    ...
    /// file is fine and pdfce is not finished*, *the file is encrypted and
    /// pdfce has not been told the password*.
...
fn spring_id() -> egui::Id {
    egui::Id::new("pdfce-doc-tab-spring") // ui-text-exempt: an id, never displayed
}

...
//! responsible for the honesty of the match, and `pdfce-core` is explicit that
...
/// register.
pub(super) fn embed(doc: &mut OpenDoc, request: &pdfce_core::font_embed_missing::EmbedRequest) {

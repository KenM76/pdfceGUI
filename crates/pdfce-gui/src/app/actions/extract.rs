...
//! picker, the same `PDFCE_DIAG_SAVE_PATH` seam that lets a driven check answer
...
mod tests {
    ...
    fn scratch(name: &str) -> PathBuf {
        let dir = std::env::temp_dir().join("pdfce-gui-extract-tests");
    ...
    fn edit(doc: &mut OpenDoc, verb: impl FnOnce(&mut pdfce_core::edit::EditSession)) {

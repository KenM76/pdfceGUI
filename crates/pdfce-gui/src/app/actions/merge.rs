...
//! file"*, and had **no arm** in `PdfceApp::dispatch_command` — so every press
...
//!
//! `pdfce_core::pageops::merge` implements Acrobat's Combine Files behaviour
...
//!
//! Two of them matter enough to name here, because they are pdfce policy that
...
/// here. Sorting by name would be a rule pdfce invented; leaving it alone means

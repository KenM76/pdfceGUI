...
//! naming the file's own problem — *"pdfce does not place GIF images — it
//! places PNG, JPEG, BMP and TIFF"*, *"this image uses {feature}, which pdfce
...
//! its resolution is one the file declared or one pdfce assumed.
//!
...
//! pdfce's own while the detail stays the file's.
//!

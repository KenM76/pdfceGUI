...
//! | run not in a recognised block | this text is not laid out as a paragraph pdfce can re-wrap |
//!
...
fn arm(app: &mut crate::app::PdfceApp, ctx: &egui::Context, id: &str) {
    match id {

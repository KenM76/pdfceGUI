...
pub fn dispatch(app: &mut PdfceApp, ctx: &egui::Context, id: &str, actions: &mut Vec<Action>) {
    match id {
...
fn copy_or_cut(app: &mut PdfceApp, ctx: &egui::Context, cutting: bool, actions: &mut Vec<Action>) {
    ...
    // and the marker is what makes a pdfce→pdfce paste discoverable at all.
...
fn paste(app: &mut PdfceApp, ctx: &egui::Context, actions: &mut Vec<Action>) {

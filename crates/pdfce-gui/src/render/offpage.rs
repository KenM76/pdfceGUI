...
//!
//! Answering that against `pdfce-core` and `pdfce-render` source on 2026-08-21
...
//!
//! `pdfce_render::render_page_region` takes an arbitrary page-space rectangle
...
//! ## What this is NOT
//!
//! Not a test of `pdfce-render`. That crate is
//! [read-only to this project](../../../../PROJECT_PLAN.md) and its coverage is
//! its own business. This is **pdfce-gui asserting the properties it is about to
...
//! `pdfce-core`'s option structs: assert the contract you depend on, where you
//! depend on it.
...
mod tests {
    ...
    fn region_of(doc: &crate::app::state::OpenDoc, region: Rect) -> (u32, u32) {
        ...
        let out = pdfce_render::render_page_region(&view, page, SCALE, region, &options)

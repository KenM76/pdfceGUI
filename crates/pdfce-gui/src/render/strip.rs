...
//! operator cannot tell "pdfce has not drawn this yet" from "this sheet is
//! empty" — and on a drawing set, "sheet 12 is blank" is a claim about their
//! document that pdfce would be making falsely.
//!
...
//! `pdfce_render::MAX_PIXMAP_EDGE`, accounting for `pixels_per_point`. That
...
/// `crate::app::state::PdfceApp::settle_and_rasterize` takes towards the

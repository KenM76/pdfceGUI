//! # `render::raster` — the bridge from `pdfce-render`'s pixmaps to egui textures
//!
...
use pdfce_render::{Diagnostics, tiny_skia};
...
const PAGE_TEXTURE_ID: &str = "pdfce-page"; // ui-text-exempt: internal texture id, never displayed

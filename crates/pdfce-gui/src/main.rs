...
//!
//! Argument handling belongs *here* rather than in [`pdfce_gui::run`]
...
//
// Note for anyone chasing a `PDFCE_DIAG` trace out of a RELEASE build: the

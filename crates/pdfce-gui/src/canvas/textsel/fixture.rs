...
//! could be published. It stays at `D:\Dev\temp\pdfce\SW41177.pdf` and is used
...
//!
//! `pdfce-core` can author text, and using it here would make the fixture a
...
mod tests {
    ...
    /// deliberately —
    /// `cargo test -p pdfce-gui regenerate_the_rotated_text_fixture -- --ignored`

...
//! answers for a **ce dimension**; this answers for everything else pdfce puts
...
//!
//! `pdfce-core` shipped `move_annotation` on 2026-08-28 (`Pass 149.0`) and its
...
//! > screenshot, right in pdfce — and is reconstructed **in the old place** by
...
#[must_use]
fn eligible(selection: &SelectionState) -> Option<(pdfce_core::object::ObjId, Rect)> {

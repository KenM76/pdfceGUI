...
//! `pdfce-core` by way of [`super::pick`] / [`super::scale`], and the one
//! engine value named directly is [`pdfce_core::dimension::DEFAULT_GROUP_ID`] —
...
use pdfce_core::dimension::{DimensionKind, GroupId};
...
mod tests {
    use super::*;
    use pdfce_core::vector::linepick::PickedLine;

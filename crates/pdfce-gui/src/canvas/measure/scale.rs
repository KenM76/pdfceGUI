...
//! over `pdfce-core` types and **never over egui**, so every transition is
...
//! is what was *checked*: every `pdfce-core` item named above still exists at

...
//!
//! The snap **maths** lives in `pdfce_core::vector::snap` and is GUI-free: give
...
//! ## Where it came from
//!
//! Salvaged from the old shell's `crates/pdfce-gui/src/canvas.rs:1584-1892`
//! (`D:\Dev\pdfce`, read-only to this project) — the block headed *"Fuzzy snap

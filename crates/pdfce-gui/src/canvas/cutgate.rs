...
//!
//! `pdfce-core`, unprompted, on 2026-08-29 —
...
//! > pdfce cannot carry costs nothing — the original stays, the clip carries an
...
//! fonts as it goes, **with no cache anywhere in `pdfce-core`**. A ribbon

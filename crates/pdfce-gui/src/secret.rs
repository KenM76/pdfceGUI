...
//! `PDFCE_DIAG`, and **`tools/ui-verify` captures that stderr to a file it
//! keeps as evidence**.
//!
...
//! comparison that matters is `pdfce-core`'s, inside the document's own
//! authentication.
...
impl Secret {
    ...
    ///
    /// ★★ Not idle curiosity: `pdfce-core` reports
...
mod tests {
    ...
    /// "pdfce cannot normalise this password" — see [`Secret::has_non_ascii`].
    #[test]

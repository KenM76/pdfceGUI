...
//!
//! The surface for `pdfce-core` `Pass 161.0`'s two verbs,
...
/// *"the drag missed"*, *"pdfce deleted it"* — is wrong.
///
...
/// register"* and *"pdfce moved it somewhere I cannot see"*, the second of
...
pub const fn bookmark_move_declined_engine() -> &'static str {
    "That bookmark was not moved \u{2014} pdfce declined the change, and the \

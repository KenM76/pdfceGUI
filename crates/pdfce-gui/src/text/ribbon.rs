...
//! with the file as a whole, and with pdfce itself: open, save a copy,
...
// changes) that pdfce does not have and will want the name for when it
...
#[must_use]
pub fn group_file_pdfce() -> &'static str {
    "pdfce"
}

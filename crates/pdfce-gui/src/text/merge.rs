//! # `text::merge` — what pdfce says about combining files
//!
...
//! the operating system draws — and these are what *pdfce* says afterwards, on
...
/// **It did not work**, and pdfce is not pretending to know why in one line.
///
...
mod tests {
    ...
    /// *consume*, and an operator who has just pointed pdfce at four drawings

...
//! because **ce dimensions** (the ones pdfce authors) and **pdf dimensions**
//! (CAD-exported page content pdfce must not alter) have opposite properties.
//!
...
//! CeDimension` — annotations pdfce itself wrote. A pdf dimension exported by

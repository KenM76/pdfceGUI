...
//!   applies unchanged.
//! - **C — what pdfce last worked out.** The disclosure block, rendered only
...
//! Option<&MenuHost>, &mut Vec<Action>)` and **the pen is on `PdfceApp`**. A
...
/// **Block C — what pdfce last worked out, in full, at panel width.**
///

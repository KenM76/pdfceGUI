...
pub struct DimensionGroupsUi {
    ...
    new_unit: Unit,
    /// Set by the *Set scale…* button, drained by `crate::app::PdfceApp`.
    ///
    ...
    ///
    /// Drained in `PdfceApp::docks`, immediately after the dock body closes and
...
impl Default for DimensionGroupsUi {
    /// ★ Hand-written, and `pdfce_core::dimension::Unit` is why.
    ///
...
impl DimensionGroupsUi {
    ...
    ///
    /// Called by `PdfceApp::docks` immediately after the dock draws. Returning

...
//! `pdfce-core` with **no GUI surface of any kind** — not a command, not a
...
//! `pdfce-core` exposes **no verb that edits one afterwards**.
//!
...
//! [`AttachmentAction::Attach`]; `PdfceApp::apply` opens the picker, in step 3,

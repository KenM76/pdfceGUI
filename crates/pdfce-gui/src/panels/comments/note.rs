...
//! Apply button, and the same one `pdfce-core` itself makes about looping a
//! singular verb.
//!
...
impl NoteDraft {
    ...
    /// rows `pdfce-core`'s own reply lists as what a review IS, and it would be
...
mod tests {
    ...
    /// annotation in a file pdfce has not rewritten.
    fn id(num: u32) -> ObjId {

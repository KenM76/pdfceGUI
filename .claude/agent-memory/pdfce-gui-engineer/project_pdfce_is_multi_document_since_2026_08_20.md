---
name: pdfce-is-multi-document-since-2026-08-20
description: pdfce-gui holds several documents at once behind a tab strip; the active one is still PdfceApp::status and everything else reads that field unchanged
metadata:
  type: project
---

**pdfce-gui went multi-document on 2026-08-20**, on Ken's request: *"make it so
...
`PdfceApp::status`**, unchanged, and every panel, the canvas, the status bar,

...
description: "A pdfce-core gap is not a reason to defer a GUI feature — decompose the operation into the verbs that exist and build it. Ken's directive, 2026-08-19."
metadata:
  type: feedback
---

**A missing or slow-to-arrive `pdfce-core` verb is not an acceptable reason to
...
slowness of feature from pdfce as a reason not to implement."*
...
- Before writing "blocked on `pdfce-core`", read the **whole** verb list

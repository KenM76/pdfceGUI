...
| **Latest build** | `OneDrive\pdfceGUI1`, published 2026-08-29 from shell `245ff21` on engine `3ac9dd7` — lossless form-field copy/paste, unsigned signature fields, the dotted-name guard, and the **paste-order setting** (Settings ▸ Display). `pdfceGUI2` holds the previous build as the fallback. Open **About** and read the Build block rather than trusting this row |

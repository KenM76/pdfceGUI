...
| **Latest build** | `OneDrive\pdfceGUI2`, published 2026-08-29 from shell `a281e99` on engine `0eb9119` — **O59 complete**: cut refuses what it cannot carry, whole pages and bookmark subtrees copy and paste. `pdfceGUI1` holds the previous build as the fallback. Open **About** and read the Build block rather than trusting this row |
